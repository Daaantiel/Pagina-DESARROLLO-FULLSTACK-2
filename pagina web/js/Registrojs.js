...
form.addEventListener("submit", (e) => {
    ...
    if (mensajesError.length > 0) {
        ...
        // Si el correo contiene 'duocuc', marcar usuario especial
        const usuarioDuocuc = correo.toLowerCase().includes("duocuc");
        const usuario = { nombre, correo, password, usuarioDuocuc };
